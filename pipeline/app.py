...
retrieval = Retrieval("def_blacklist.pt", threshold=0.90, debug=True, debugAverage=True, usingAverage=False, usingMedian=True, usingMax=True, toVisualize=True, usingMtcnn=False)
