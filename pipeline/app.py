...
retrieval = Retrieval("def_blacklist.pt", threshold=0.90, debug=True, debugAverage=True, usingAverage=True, toVisualize=True, useDynamicDetection=False, usingMtcnn=False)
